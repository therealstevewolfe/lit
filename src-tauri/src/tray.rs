...
pub fn get_icon_path(theme: AppTheme, state: TrayIconState) -> &'static str {
    match (theme, state) {
        ...
        (AppTheme::Colored, TrayIconState::Idle) => "resources/lit.png",
...
fn version_label() -> String {
    if cfg!(debug_assertions) {
        format!("Lit v{} (Dev)", env!("CARGO_PKG_VERSION"))
    } else {
        format!("Lit v{}", env!("CARGO_PKG_VERSION"))
    }
}
